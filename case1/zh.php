...
<div calss="row mt50"></div>
   ...
   <form action="./com/zhdo.php" method="post" class="form-horizontal col-md-4 col-md-offset-4">
...
<!-- 
      ...
      <div class="form-group">
        <div class="col-md-12">
          <button type="submit" class="btn btn-primary btn-lg btn-block">找回</button>
          
          <a href="./reg.php" class="pull-right">人工帮助</a>
        </div>
      </div>
